...
type StaffCreatableRole = Extract<UserRole, 'receptionist' | 'doctor' | 'therapist' | 'follow_up_agent'>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 border-b border-slate-100 pb-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">Create receptionist, doctor, therapist, and follow-up agent login accounts. Public signup remains closed.</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    {staffUsers.length === 0 ? (
                      <div className="rounded-2xl border border-dashed border-slate-200 p-8 text-center">
                        ...
                        <p className="text-xs text-slate-500 mt-1">Create receptionist, doctor, therapist, and follow-up agent logins above.</p>
                      </div>
